    ...
    fetch(baseUrlTodosOsCandidatos)
        ...
        .then(data => {
            ...
            if (candidato) {
                ...
                document.querySelector('#idCandidato').value = candidato.id;
                document.querySelector('#nomecandidato').value = candidato.nome;
                document.querySelector('#idCandidato').value = candidato.urlFoto;
                infoDiv.innerHTML = `
